...
public final class DependencyTreeObjectMother {

	private DependencyTreeObjectMother() {
		// Hide utility class constructor
	}

	/**
	 * Creates the following String graph:
	 * 
	 * <pre>
	 *     A
	 *    / \
	...
	private static SimpleDependencyNode node(String item) {
		return new SimpleDependencyNode(item);
	}
}
